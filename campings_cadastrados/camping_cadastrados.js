 ...
 function carregarCampings() {
    ...
    campings.forEach((camping, index) => {
        ...
        campingItem.innerHTML = `
            <p><strong>Nome do Camping:</strong> ${camping.nomeCamping}
            <p><strong>Nome:</strong> ${camping.nome}</p>
            <p><strong>Email:</strong> ${camping.email}</p>
            <p><strong>Telefone:</strong> ${camping.telefone}</p>
            <p><strong>CPF:</strong> ${camping.cpf}
            ...
            <p><strong>Selecione uma imagem do Camping</strong> ${camping.imageUpload}</p>
